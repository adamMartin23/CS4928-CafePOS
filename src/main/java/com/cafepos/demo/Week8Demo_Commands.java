...
public final class Week8Demo_Commands {
    public static void main(String[] args) {
        ...
        remote.setSlot(0, new AddItemCommand(service, "ESP+SHOT+OAT", 1)); //2.50 + 0.80 + 0.50 = 3.80
        remote.setSlot(1, new AddItemCommand(service, "LAT+L", 2)); //(3.20 + 0.70) * 2 = 3.90 * 2 = 7.80
